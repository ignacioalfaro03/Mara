# MARA VERA — INSTAGRAM OPERATING INDEX

Status: **START HERE FOR INSTAGRAM PRODUCTION**

Instagram is a persistent-world production system, not a folder of prompts.
...
Never skip from idea directly to a batch of final images when the frames share continuity.

---

## The repository-state test

A new production agent should be able to answer from this folder, without chat history:

- Which post is active?
- Which frame is next?
- What is Mara wearing?
- Which objects are locked?
- Where is the scene?
- What did the previous frame establish?
- Who is taking the next picture?
