const ACTION_TITLES: Record<string, string> = {
  ...
  follow_up_bidder: "Convierte intención de subasta en una nueva oportunidad.",
  consider_offer_from_demand: "Hay demanda repetida: conviértela en una oferta.",
  recognize_repeat_supporter: "Reconoce a quien ya te apoyó más de una vez.",
