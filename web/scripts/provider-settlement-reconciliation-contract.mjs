...
// Release-gate reconciliation must cover capture, fee and unmatched provider money truth.
assert.match(sql, /PROVIDER_SETTLEMENT_EVIDENCE_MISSING/);
assert.match(sql, /PROVIDER_SETTLEMENT_CAPTURE_MISMATCH/);
assert.match(sql, /PROVIDER_PROCESSOR_FEE_MISMATCH/);
...
// This slice must not create payout automation.
