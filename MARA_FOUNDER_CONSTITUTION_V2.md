...
> **ONE COMPANY. ONE THESIS. FEW CORE ENGINES. NO ORPHAN IDEAS.**
...
- **WANT** = low-friction interest.
- **PLEDGE** = stated willingness to pay.
- **COMMIT** = materially stronger purchase intent under defined conditions.
- **AGGREGATED DEMAND** = grouped economic signal across users.
...
Purpose: learn what communities actually want before supply is overbuilt.
...
- unlimited AI chat;
- deep relationship-state engineering;
- generic social feed;
...
No new idea enters the roadmap unless it answers:

1. Which of the four engines does it strengthen?
2. Which user/payer does it serve?
...
# 18. SAFETY / COMPLIANCE / PAYMENT BOUNDARY

- adults only where required;
- truthful creator/AI disclosure;
